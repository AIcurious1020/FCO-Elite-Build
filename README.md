...
| Area | What it does |
|-----|--------------|
| Dashboard | Chairman brief plus linkable hub boxes with status and action summaries |
...
| Transfers | Outgoing offer holding room, replacement search, role-based Deal Room approvals, scout targets, DoF and manager views, bid with clear accept/reject rules |
